...
class ShippingDelivery extends StatefulWidget {
  ...
  @override
  State<ShippingDelivery> createState() => _ShippingDeliveryState();
}
        ...
        children: [
          Center(
              ...
              child:Padding(
                ...
                child: Text("Shipping & Delivery",style: Whitebackgroundstyle.copyWith(color: Colors.black.withAlpha(150),fontSize: 20),),
              )),
